        ...
        <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.unlockedBriefCard}>
            ...
            <Text style={styles.unlockedBriefText}>
              Recovery is up <Text style={styles.boldText}>8%</Text> after last night's sleep. Your <Text style={styles.boldText}>BPC-157 cycle</Text> enters <Text style={styles.boldText}>week 3</Text>.
            </Text>
          ...
          {/* Warning Banner */}
          {showAlert && <View style={styles.alertBanner}>
            <View style={styles.alertHeaderRow}>
              <FramenoIcon />
              <Text style={styles.alertTitle}>You haven't logged weight in 3 days</Text>
            </View>
            <Text style={styles.alertBody}>
              Kindly log your weight to maintain your streak.
            </Text>
            <TouchableOpacity style={styles.dismissButton} onPress={() => setShowAlert(!showAlert)}>
