...
const SparkleIconBadge = ({ size = 237 }) => {
  const scale = size / 237;
      ...
      <View
        style={[
          styles.circle,
          {
            width: 136 * scale,
            height: 136 * scale,
            borderRadius: (136 * scale) / 2,
            backgroundColor: '#F7E1FE',
          },
        ]}
      />
      ...
      <View style={styles.iconWrapper}>
        ...
        >
          <Defs>
            ...
            >
              <Stop offset="0" stopColor="#BD2BF2" />
...
export default SparkleIconBadge;